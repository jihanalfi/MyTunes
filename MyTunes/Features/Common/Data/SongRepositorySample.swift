...
class SongRepositorySample{
    ...
    static func getSongs() -> [Song] {
        return [
            ...
            Song(title: "How Deep Is Your Love", artist: "Bee Gees", album: "How Deep Is Your Love", pathFile: "Bee Gees - How Deep Is Your Love", pathImage: "BeeGees"),
            ...
            Song(title: "I Just Called To Say I Love You", artist: "Stevie Wonder", album: "I Just Calles To Say I Love You", pathFile: "Stevie Wonder - I Just Called To Say I Love You", pathImage: "StevieWonder")
